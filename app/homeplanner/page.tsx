  ...
  return (
    <div className="relative min-h-screen bg-white font-schibsted overflow-x-hidden antialiased">
          ...
          <div className="hidden lg:flex items-center gap-[32px]">
            {["Marketplace", "Home Planner", "Pricing", "About"].map((item) => (
              <Link
                ...
                className={`text-[15px] font-medium transition-colors hover:text-[#004643] ${item === "Home Planner" ? "text-[#004643] font-bold" : "text-[#555f6d]"
                  }`}
              >
                {item}
              </Link>
      ...
      <section className="relative pt-[160px] md:pt-[200px] pb-[100px] px-4 overflow-hidden">
        ...
        <div className="max-w-[1240px] mx-auto text-center relative z-10">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 bg-white border border-[#e2e8f0] rounded-full mb-10 shadow-sm"
          >
            <div className="w-2 h-2 bg-[#10b981] rounded-full animate-pulse" />
            <span className="text-[13px] font-medium text-[#555f6d] tracking-tight">New: AI-Powered Layout Engine</span>
          </motion.div>
          ...
          <motion.h1
            ...
            className="text-[48px] sm:text-[64px] lg:text-[84px] font-bold text-[#004643] leading-[1] mb-2 tracking-[-2px] font-schibsted"
          >
            AI Home Planner
          </motion.h1>
          <motion.h2
            ...
            className="text-[36px] sm:text-[54px] lg:text-[72px] font-instrument italic text-[#555f6d] leading-[1.2] mb-10 tracking-[0.02em]"
          >
          ...
          <motion.p
            ...
            className="max-w-[760px] mx-auto text-[17px] md:text-[19px] text-[#555f6d] leading-[1.6] opacity-80 mb-14"
          >
            Create professional-grade floor plans in minutes. From conceptual sketches to detailed 3D walkthroughs, bring your vision to life with our intuitive planner.
          </motion.p>
          ...
          <motion.div
            ...
            className="max-w-[760px] mx-auto bg-white p-2 rounded-[16px] shadow-[0_0_0_1px_rgba(17,24,39,0.05),0_20px_25px_-5px_rgba(0,0,0,0.1),0_8px_10px_-6px_rgba(0,0,0,0.1)] flex items-center group transition-all"
          >
            <div className="pl-6 pr-4 flex-1 flex items-center gap-4">
              ...
              <input
                type="text"
                placeholder=""
                className="w-full h-full bg-transparent outline-none text-[16px] text-[#111d27] placeholder:text-[#94a3b8] font-medium"
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="group bg-[#F9FAFB] rounded-[32px] p-8 border border-black/[0.03] shadow-sm hover:shadow-xl transition-all"
              >
      ...
      <section className="py-[100px] md:py-[140px] px-4 bg-[#004643] overflow-hidden relative">
        ...
        <div className="absolute left-[45%] top-[40%] w-40 h-20 bg-white/5 blur-3xl rounded-full pointer-events-none" />
        ...
        <div className="max-w-[1240px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-[120px]">
          ...
          <div className="flex-1 text-white relative z-10 w-full lg:max-w-[640px]">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-white/10 border border-white/10 rounded-full mb-8">
              <span className="text-[15px] font-medium text-white/90">Complete Workflow</span>
            </div>
            <h2 className="text-[40px] md:text-[56px] font-bold leading-[1.1] mb-8 tracking-tight lg:whitespace-nowrap">From Blueprint to Reality</h2>

            <p className="text-white/70 text-[16px] md:text-[18px] leading-relaxed mb-12">
              Nooi isn't just a planner; it's an end-to-end platform. We connect your digital design directly to logistics, making sure what you see is exactly what you get delivered.
            </p>

            <div className="space-y-10 mb-16">
              {[
                { step: "1", title: "Design & Visualize", desc: "Create your layout and visualize it with photorealistic rendering." },
                { step: "2", title: "Select Furniture", desc: "Browse our catalog of real products that fit your specific dimensions." },
                { step: "3", title: "Order & Install", desc: "One-click ordering for your entire room. We handle the shipping and setup." }
              ].map((item, i) => (
                <div key={i} className="flex gap-6 items-start">
                  <div className="w-10 h-10 bg-white/10 border border-white/5 rounded-full flex items-center justify-center shrink-0 font-bold text-[14px]">
                    {item.step}
                  </div>
                  <div>
          ...
          {/* Right: Large Image with Badge Overlap */}
          <div className="flex-1 w-full flex justify-center lg:justify-end relative group">
            {/* Tilted Image Container - Responsive Scaling */}
            ...
            {/* Floating Modular Sofa Badge - Responsive Positioning */}
            <motion.div 
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              className="absolute bottom-[-20px] lg:bottom-[-30px] left-1/2 -translate-x-1/2 lg:left-[-40px] lg:translate-x-0 w-[calc(100%-40px)] max-w-[280px] bg-white rounded-[24px] p-5 shadow-[0_30px_60px_rgba(0,0,0,0.4)] border border-white/50 z-20"
            >
              <div className="flex items-center gap-4 mb-5">
                ...
                <div>
                  <p className="text-[15px] font-bold text-[#111d27] mb-0.5">Modular Sofa</p>
                  <div className="flex items-center gap-1.5">
                    <span className="text-[12px] font-bold text-[#10b981]">In Stock</span>
                    <span className="text-[12px] text-[#94a3b8]">•</span>
                    <span className="text-[12px] font-bold text-[#10b981]">Fits Perfectly</span>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-[1240px] mx-auto">
          <div className="flex flex-col md:flex-row items-end justify-between mb-12 gap-6">
            <div className="text-left">
              <h2 className="text-[32px] md:text-[44px] font-bold text-[#004643] mb-4 tracking-tight">Popular Layouts</h2>
              <p className="text-[18px] text-[#555f6d] opacity-70">Start with a template or explore what others have created.</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: "Urban Studio Apartment", tag: "Studio", meta: "450 sq ft • Open Concept", img: "/assets/tdv.png" },
              { title: "Modern Island Kitchen", tag: "Kitchen", meta: "250 sq ft • Minimalist", img: "/assets/mik.png" },
              { title: "Master Suite", tag: "Bedroom", meta: "350 sq ft • Contemporary", img: "/assets/cms.png" }
            ].map((layout, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className="group cursor-pointer bg-white rounded-[32px] p-0 border border-black/[0.03] shadow-sm hover:shadow-xl transition-all overflow-hidden"
              >
                <div className="relative aspect-[1.4/1] overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 px-3 py-1 bg-white/90 backdrop-blur-sm rounded-full">
                    <span className="text-[10px] font-medium items-center justify-center text-[#111d27] uppercase tracking-1">{layout.tag}</span>
                  </div>
                </div>
                <div className="p-8">
                  ...
                  <div className="pt-6 border-t border-[#f1f5f9] flex justify-between items-center">
                    ...
                    <span className="text-[14px] font-bold text-[#004643] group-hover:underline">Use Template</span>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      {/* CTA SECTION */}
      <section 
        className="py-[120px] md:py-[160px] px-4 lg:px-8 relative flex justify-center items-center overflow-hidden"
        style={{
          background: `linear-gradient(180deg, rgba(1, 28, 27, 0.52) 0%, rgba(0, 78, 75, 0.87) 97.32%), url('/assets/kitchen.jpg') lightgray 50% / cover no-repeat`
        }}
      >
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full max-w-[1280px] px-5 py-[80px] md:py-[100px] lg:px-[200px] bg-white/5 backdrop-blur-[12px] border border-white/20 rounded-[24px] shadow-[0_8px_32px_rgba(0,0,0,0.2)]">
          <h2 className="mb-[16px] md:mb-[24px] text-[40px] md:text-[80px] font-medium text-white tracking-tight text-center leading-[1.1]">
            Ready to redesign<br /><span className="text-white/70">your space?</span>
          </h2>
          <p className="text-white/70 text-[16px] md:text-[18px] text-center leading-relaxed">
            Join thousands of homeowners and designers who are creating beautiful<br className="hidden md:block" />homes with Nooi.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-[16px] mt-[32px] md:mt-[48px]">
            ...
            {/* Book a Demo */}
            <button className="h-[52px] px-[28px] border border-white/40 hover:bg-white/10 text-white rounded-[12px] font-medium text-[15px] transition-all">
              Book a Demo
            </button>
          </div>
        </div>
